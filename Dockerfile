...
RUN apt update && apt dist-upgrade -y && \
    apt install -y clamav git libpcre3-dev build-essential libdb-dev libopendmarc-dev python-setuptools libmysqlclient-dev libspf2-dev libsasl2-dev libldap2-dev libdkim-dev libgnutls28-dev pkg-config libidn11-dev libpam-dev && \
