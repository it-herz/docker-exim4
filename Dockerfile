...
RUN apt update && apt install -y git libpcre3-dev build-essential libdb-dev libopendmarc-dev libspf2-dev libsasl2-dev libldap2-dev libdkim-dev libgnutls28-dev pkg-config libidn11-dev libpam-dev && \
